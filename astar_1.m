...
%                                 fn = CurrDeltaVertical;% 为相邻节点之间的距离，越大越好 
                                ...
                                back_open_set_list(r+1,:) = [col fn 0 CurrDeltaHorizontal dis];
...
%                                 fn = CurrDeltaHorizontal;% 为相邻节点之间的距离，越大越好 
                                ...
                                open_set(col) = 1;
                                [r,c] = size(back_open_set_list);
                                back_open_set_list(r+1,:) = [col fn CurrDeltaVertical 0 dis];
                            end
                        end
                    end
...
saveas(gca,'astar_1_1.fig');
saveas(gca,'astar_1_1.emf');
